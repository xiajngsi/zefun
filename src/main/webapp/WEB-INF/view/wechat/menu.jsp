							...
							<div class="defined-menu">
				                    <div class="sub_title_bar light" >
				                        ...
				                        <div class="opr_wrp" style="height: 45px;">
				                            <a id="menu-add" href="javascript:void(0);" class="addBt opr_meta icon16_common add_gray" style="margin-left: 250px;margin-top: 6px;">添加</a>
				                        </div>
         							</div>
						...
						<table class="table">
							...
							<tbody>
								<c:forEach items="${automaticReplies }" var="replies"> 
								    <tr>
										<td>  
										   <input type="hidden" value="${replies.url }" name="menuUrl"/>
