           	    ...
           	    qiniu2.uploader({
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					var res = eval('(' + info + ')');
           					var sourceLink = domain + res.key;
           						UE.getEditor('editor2').execCommand('insertHtml', '<img src="'+sourceLink+'">');
           	    ...
           	    qiniu3.uploader({
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					var res = eval('(' + info + ')');
           					var sourceLink = domain + res.key;
           						UE.getEditor('editor3').execCommand('insertHtml', '<img src="'+sourceLink+'">');
           	    ...
           	    qiniu4.uploader({
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					var res = eval('(' + info + ')');
           					var sourceLink = domain + res.key;
           						UE.getEditor('editor4').execCommand('insertHtml', '<img src="'+sourceLink+'">');
           	    ...
           	    qiniu5.uploader({
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					var res = eval('(' + info + ')');
           					var sourceLink = domain + res.key;
           						UE.getEditor('editor5').execCommand('insertHtml', '<img src="'+sourceLink+'">');
           	    ...
           	    qiniu6.uploader({
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					var res = eval('(' + info + ')');
           					var sourceLink = domain + res.key;
           						UE.getEditor('editor6').execCommand('insertHtml', '<img src="'+sourceLink+'">');
           	    ...
           	    qiniu7.uploader({
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					var res = eval('(' + info + ')');
           					var sourceLink = domain + res.key;
           						UE.getEditor('editor7').execCommand('insertHtml', '<img src="'+sourceLink+'">');
           	    ...
           	    qiniu8.uploader({
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					var res = eval('(' + info + ')');
           					var sourceLink = domain + res.key;
           						UE.getEditor('editor8').execCommand('insertHtml', '<img src="'+sourceLink+'">');
