...
public class CustomeranalysisController extends BaseController {
    ...
    * @return ModelAndView
     */
    @RequestMapping(value = Url.Businessanalysis.CUSTOMERANALYSIS)
    public ModelAndView attendanceView(HttpServletRequest request, HttpServletResponse response){
        ...
        ModelAndView mav = new ModelAndView("businessanalysis/customeranalysis/customeranalysis");
        return mav;
    }
