 ...
 * 卡项销售
* @author chendb
* @date 2015年10月24日 上午11:51:02
 */
@Controller
public class CardsalesController extends BaseController{
    /**
     * 
    * @author chendb
    ...
    * @return ModelAndView
    ...
    public ModelAndView attendanceView(HttpServletRequest request, HttpServletResponse response){
        ...
        ModelAndView mav = new ModelAndView("businessreport/cardsales/cardsales");
        return mav;
    }
}
