...
public class BusinessanalysisController extends BaseController{
    ...
    * @return ModelAndView
     */
    @RequestMapping(value = Url.Businessanalysis.BUSINESSANALYSIS)
    public ModelAndView attendanceView(HttpServletRequest request, HttpServletResponse response){
        ...
        ModelAndView mav = new ModelAndView("businessanalysis/businessanalysis/businessanalysis");
        return mav;
    }
